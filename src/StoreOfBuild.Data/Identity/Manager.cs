...
namespace StoreOfBuild.Data.Identity
{
    public class Manager : IManager
    {
        ...
        public Manager(UserManager<ApplicationUser> userManager, Microsoft.AspNetCore.Identity.SignInManager<ApplicationUser> signInManager, ApplicationDbContext dbContext)
        {
